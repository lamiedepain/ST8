...
(function (global) {
    ...
    function buildGlobalStatusDoughnut(agents) {
        ...
        _globalStatusChart = new Chart(ctx.getContext('2d'), { type: 'doughnut', data: { labels: codes, datasets: [{ data, backgroundColor: colors }] }, options: { plugins: { legend: { position: 'bottom' } } } });
    }
